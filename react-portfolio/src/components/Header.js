...
function Navigation(props) {
  ...
  return (
    ...
    <Nav className="nav" fill variant="pills" defaultActiveKey="/home">
      ...
      <Nav.Item>
        <Nav.Link href="#contacts" onClick={() => props.handlePage('contacts')} eventKey="link-2">Contacts</Nav.Link>
      </Nav.Item>
      <Nav.Item>
        <Nav.Link href="#resume" onClick={() => props.handlePage('resume')} eventKey="link-3">
          Resume
        </Nav.Link>
      </Nav.Item>
    </Nav>
